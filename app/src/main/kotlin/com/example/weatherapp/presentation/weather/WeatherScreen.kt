  ...
  LazyColumn(
    ...
    item {
      ...
      CurrentWeatherCard(
        ...
        highTemperature = viewModel.forecastWeatherResponse?.forecast?.forecastday?.get(0)?.day?.maxtempC.toString(),
        lowTemperature = viewModel.forecastWeatherResponse?.forecast?.forecastday?.get(0)?.day?.mintempC.toString(),
        weatherIconUrl = viewModel.currentWeatherResponse?.current?.condition?.icon.toString(),
        feelsLikeTemperature = viewModel.currentWeatherResponse?.current?.feelslikeC.toString()
      )
